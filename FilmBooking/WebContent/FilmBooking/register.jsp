...
<html>
	...
	<body>
		...
		<br><br><h1 align="center"> 회원 가입 </h1><br><br>
		
<form action="control_member.jsp?action=register" method="post">
...
%>					
		...
		<p align="center">
			<br><br>
			<input type="submit" value="회원가입" style="width:100pt; height:30pt; margin-right:15pt; background-color:#dedede"/>
